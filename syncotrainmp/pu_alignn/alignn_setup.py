...
def train_for_folder(
    ...
    from syncotrainmp.pu_alignn.pu_learn.PU_data_handling import (
    ...
    with open(
        os.path.join(os.path.dirname(train_id_path), "experimentalDataSize.txt")
    ) as eds:
        experimentalDataSize = int(float(eds.read().strip()))

    data_csv_path = os.path.join(root_dir, f"{data_prefix}{prop}_id_from_{TARGET}.csv")
    ...
    data_portion_dict = {
        "positive_data_size": positiveSize,
    ...
    for i in data:
        ...
        file_path = os.path.join(
            root_dir, f"{data_prefix}atomistic_{prop}_{experiment}", file_name
        )
    ...
    print(
        "The size of positive labeled data is ", data_portion_dict["positive_data_size"]
    )
    print(
        "The size of experimental data is ", data_portion_dict["experimentalDataSize"]
    )
    print("The size of unlabeled data is ", data_portion_dict["unlabeled_data_size"])
