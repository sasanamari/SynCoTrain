...
class MyEarlyStopping(Serializable):
    ...
    def __call__(self, engine: Engine) -> None:
        ...
        score = score[1] #only for recall, since it retunrs recall for both classes, although it shouldn't.
        # print("the current score is ", score.__repr__())
        # print("the current best_score is ", self.best_score.__repr__())
        # print("the current min_delta is ", self.min_delta.__repr__())
        
        if self.best_score is None:
            self.best_score = score
            # print('Best score in now ', self.best_score.__repr__())
            # print('=================')
