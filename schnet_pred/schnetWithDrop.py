...
__all__ = ["SchNet", "SchNetInteractionWithDrop"]


class SchNetInteractionWithDrop(nn.Module):
    ...
    def __init__(
        ...
        """
        super(SchNetInteractionWithDrop, self).__init__()
...
class SchNet(nn.Module):
    ...
    def __init__(
        ...
        self.dropout_embedding = nn.Dropout(dropout_rate_embedding)

        self.interactions = snn.replicate_module(
            lambda: SchNetInteractionWithDrop(
    ...
    def forward(self, inputs: Dict[str, torch.Tensor]):
        ...
        x = self.dropout_embedding(x)  # Apply dropout after embedding
