# Need to have the sigmoid only at the final interaction block.
# if final interaction doesn't work, I'd try replaying the second 
# activation with final activation.
...
__all__ = ["SchNet", "SchNetInteraction", "mySigmoid"]

def mySigmoid(x: torch.Tensor):
    from torch.nn import functional
    
    """
    my classification activation
    """
    return torch.nn.functional.sigmoid(x)

class SchNetInteractionClass(nn.Module):
    r"""SchNet interaction block for classification."""
    ...
    def __init__(
        ...
        activation: Callable = mySigmoid,
        # finalActivation: Callable = mySigmoid,
    ):
        """
        Args:
        ...
        """
        super(SchNetInteractionClass, self).__init__()
        ...
        self.filter_network = nn.Sequential(
            ...
            # Dense(n_filters, n_filters, activation=finalActivation)
        )
