...
# %%
myrootpath = '/home/samariam/projects/chemheuristics/alignn'
mydatapath = "../data_for_dev_try/testData4alignn.json"
myconfigpath = '/home/samariam/projects/chemheuristics/alignn/config_example_atomwise.json'

cwd = os.getcwd()
print('current directory is', cwd)
# print('We have the files', os.listdir(cwd))
# %%
#  %%
device = "cpu"
...
def train_for_folder(
    root_dir="examples/sample_data_ff",
    config_name=myconfigpath,
    ...
    """Train for a folder."""
    dat = loadjson(os.path.join(root_dir, mydatapath))
