# %%
import os
os.environ['CUDA_VISIBLE_DEVICES'] = "0,2,3" # safer to use before loading lightning.gpu
...
dataPath = './class__prifile_dataset4.db'
save_dir = './profiling2_earlyStop2'
