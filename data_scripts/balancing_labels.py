...
# %%
df = pd.read_pickle(f'{current_dir}/../data/results/synth/synth_labels_2')
# %%
...
# %%
balanced_df_path = Path(f'{current_dir}/../data/results/synth/synth_labels_2_balanced').resolve()
